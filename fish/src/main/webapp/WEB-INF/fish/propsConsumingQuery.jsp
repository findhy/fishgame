...
<form action="${path}/propsConsumingQuery" id="propsConsumingQueryForm" method="post">
...
<div class="combination margin_l_r10" style="width:auto;height:auto">
	<div class="title2"><span class="toggle_hide">道具消耗查询</span></div>
	...
	<div class="pages">
	   <jsp:include page="../common/paging.jsp" flush = "true">
	   		<jsp:param name="url" value="/propsConsumingQuery"/>
    		<jsp:param name="searchFormId" value="propsConsumingQueryForm" />
	   </jsp:include>
	</div>
	</div>
</div>	
