...
<form action="${path}/retentionIndex" id="retentionIndexForm" method="post">
...
<div class="combination margin_l_r10" style="width:auto;height:auto">
	<div class="title2"><span class="toggle_hide">角色留存指标</span></div>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<thead>
			<tr>
				<th width="12%">时段</th>
				<th width="12%">新增设备数(激活数)</th>
				<th width="12%">累计登录设备</th>
				<th width="12%">次日留存</th>
				<th width="12%">三日留存</th>
				<th width="12%">七日留存</th>
				<th width="12%">1月留存</th>
	...
	<div class="pages">
	   <jsp:include page="../common/paging.jsp" flush = "true">
	   		<jsp:param name="url" value="/retentionIndex"/>
    		<jsp:param name="searchFormId" value="retentionIndexForm" />
	   </jsp:include>
	</div>
	</div>
</div>	
