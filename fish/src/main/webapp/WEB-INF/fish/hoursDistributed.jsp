...
<form action="${path}/hoursDistributed" id="hoursDistributedForm" method="post">
...
<div class="combination margin_l_r10" style="width:auto;height:auto">
	<div class="title2"><span class="toggle_hide">24小时用户分布</span></div>
	...
	<div class="pages">
	   <jsp:include page="../common/paging.jsp" flush = "true">
	   		<jsp:param name="url" value="/hoursDistributed"/>
    		<jsp:param name="searchFormId" value="hoursDistributedForm" />
	   </jsp:include>
	</div>
	</div>
</div>	
