...
<form action="${path}/dayWeekMonQuery" id="dayWeekMonQueryForm" method="post">
...
<div class="combination margin_l_r10" style="width:auto;height:auto">
	<div class="title2"><span class="toggle_hide">日活、周活、月活查询</span></div>
	...
	<div class="pages">
	   <jsp:include page="../common/paging.jsp" flush = "true">
	   		<jsp:param name="url" value="/dayWeekMonQuery"/>
    		<jsp:param name="searchFormId" value="dayWeekMonQueryForm" />
	   </jsp:include>
	</div>
	</div>
</div>	
