...
<form action="${path}/checkpointRetentionDataQuery" id="checkpointRetentionDataQueryForm" method="post">
...
<div class="combination margin_l_r10" style="width:auto;height:auto">
	<div class="title2"><span class="toggle_hide">关卡滞留人数统计指标</span></div>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tbody>
			<c:forEach items="${page.list}" var="list">
			   <tr>
			   	  <td><c:out value="${list.pointId}"/></td>
	...
	<div class="pages">
	   <jsp:include page="../common/paging.jsp" flush = "true">
	   		<jsp:param name="url" value="/checkpointRetentionDataQuery"/>
    		<jsp:param name="searchFormId" value="checkpointRetentionDataQueryForm" />
	   </jsp:include>
	</div>
	</div>
</div>	
